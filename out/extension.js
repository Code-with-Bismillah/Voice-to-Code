...
function activate(context) {
    ...
    context.subscriptions.push(startListeningCommand, stopListeningCommand, toggleListeningCommand, insertCodeCommand, createNewFileCommand, checkPythonCommand, transcribeMediaCommand, transcribeCurrentMediaCommand, installDependenciesCommand, statusBarItem);
}
...
async function installPythonDependencies() {
    try {
        ...
        const action = await vscode.window.showInformationMessage("This will install required Python packages: SpeechRecognition, pydub, moviepy, ffmpeg-python", "Install Now", "Cancel");
        if (action === "Install Now") {
            ...
            terminal.show();
            vscode.window.showInformationMessage("Installing dependencies... Check the terminal for progress. You may also need to install FFmpeg separately for video support.");
        }
    }
    catch (error) {
